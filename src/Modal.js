...
function SubmitModal() {
  ...
  return (
    <div>
      <button
        className="border-2 text-black 	 px-2 bg-white"
        onClick={openModal}
      >
      ...
      >
        <div>
          <div className="bg-blue-300 flex flex-col items-center py-4">
            <img
            className="rounded-full h-28 w-28 border-2 border-blue-600	"
              src={"https://agentphotos.mortgageweb.ca:5510/10549_profile.png"}
            />
            <p className="text-xl  font-extrabold	 py-4 text-white">
            Sinthusan Sivasubramaniam

            </p>
          </div>
          <p className="text-xl  font-extrabold text-blue-300	 py-4">Acknowledgement and Agreement</p>
